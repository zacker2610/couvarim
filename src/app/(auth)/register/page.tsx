      ...
      <div className="w-full max-w-lg bg-transparent sm:bg-white sm:rounded-[32px] sm:shadow-2xl sm:border sm:border-sage-100/50 overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-700">
        <div className="p-8 sm:p-12 flex flex-col items-center">
          ...
          <Link href="/" className="flex flex-col items-center mb-10 text-center group active:scale-95 transition-all">
            ...
            <h1 className="text-3xl font-bold text-gray-800 tracking-tight">Pridajte sa k nám</h1>
            <p className="text-gray-500 mt-2 font-medium">Začnite variť inteligentne s AI vo vašej kuchyni.</p>
          </Link>

          <form className="space-y-5 w-full" onSubmit={handleRegister}>
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Meno</label>
          ...
          <div className="relative my-10 text-center w-full">
          ...
          <div className="mt-10 text-center">
            <p className="text-gray-500 font-medium">
              Už máte účet?{" "}
              <Link href="/login" className="text-sage-600 font-bold hover:text-sage-700 transition-colors">
                Prihláste sa
              </Link>
            </p>
          </div>
