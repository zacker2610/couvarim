    ...
    <div className="animate-in fade-in slide-in-from-right-4 duration-500 overflow-x-hidden">
      <header className="sticky top-0 z-40 bg-[#F8F5F2]/80 backdrop-blur-md flex items-center gap-4 py-4 px-4 -mx-4 mb-6">
        ...
        <button 
          onClick={handleSave}
          disabled={isSaving}
          className="w-12 h-12 bg-sage-500 text-white rounded-2xl shadow-md active:scale-95 disabled:opacity-50 transition-all hover:bg-sage-600 flex items-center justify-center"
        >
